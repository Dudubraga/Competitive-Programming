...
void create_problem(bool open_vscode = true);
void create_contest();
void finalize_problem();

const string cpp_template = R"(
#include <bits/stdc++.h>
using namespace std;
 ...
 * @param open_vscode If true, opens VS Code in the new directory
 */
void create_problem(bool open_vscode){
    ...
    cpp_file << "/* Problem statement: " << problem_url << " */" << cpp_template;
    cpp_file.close();
